...
public class HotelMapActivity extends BaseActivity implements LocationSource,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		topbase_center_text.setText("附近住宿");
	...
	public void drawMarkers(ArrayList<HashMap<String, String>> datalist) {
		...
		for (int i = 0; i < datalist.size(); i++) {
			Double lat = Double.valueOf(datalist.get(i).get("Hote_Latitude"));
		...
		for (int i = 0; i < shoplist.size(); i++) {
			aMap.addMarker(new MarkerOptions()
					...
					.title(datalist.get(i).get("Hote_ShopName"))
					.snippet(datalist.get(i).get("Hote_Address"))
					.icon(BitmapDescriptorFactory
							.fromResource(R.drawable.icon_map_hotel)));
		}
