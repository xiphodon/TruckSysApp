 ...
 * 
 */
public class RestaurantMapActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		topbase_center_text.setText("附近餐馆");
	...
	public void drawMarkers(ArrayList<HashMap<String, String>> datalist) {
		...
		for (int i = 0; i < datalist.size(); i++) {
			Double lat = Double.valueOf(datalist.get(i).get("Rest_Latitude"));
		...
		for (int i = 0; i < shoplist.size(); i++) {
			aMap.addMarker(new MarkerOptions()
					...
					.title(datalist.get(i).get("Rest_ShopName"))
					.snippet(datalist.get(i).get("Rest_Address"))
					.icon(BitmapDescriptorFactory
							.fromResource(R.drawable.icon_mapmeal)));
		}
