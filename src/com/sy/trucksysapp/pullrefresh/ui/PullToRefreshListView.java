package com.sy.trucksysapp.pullrefresh.ui;

import com.sy.trucksysapp.R;
import com.sy.trucksysapp.page.order.OrderFragment;
import com.sy.trucksysapp.pullrefresh.ui.ILoadingLayout.State;
import com.sy.trucksysapp.utils.ScreenUtil;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView>
	...
	private View toTopView;// 返回顶部的按钮
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		case OnScrollListener.SCROLL_STATE_IDLE:// 是当屏幕停止滚动时
			...
			if (mListView.getLastVisiblePosition() == (mListView.getCount() - 1)) {
				if (getToTopView() != null) {
					getToTopView().setVisibility(View.VISIBLE);
				}
			}
			// 判断滚动到顶部
			if (mListView.getFirstVisiblePosition() == 0) {
				if (getToTopView() != null) {
					getToTopView().setVisibility(View.GONE);
				}
			}
	...
	public void setToTopView(View toTopView) {
		this.toTopView = toTopView;
	}
}
