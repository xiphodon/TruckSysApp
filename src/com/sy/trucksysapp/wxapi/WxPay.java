package com.sy.trucksysapp.wxapi;
...
public class WxPay {
	...
	public void pay(String name, String description, Double price,
			String ordernumber) {
		msgApi.registerApp(Constants.APP_ID);
		req = new PayReq();
		entity = genProductArgs(name, description, price, ordernumber);
		GetPrepayIdTask getPrepayId = new GetPrepayIdTask();
		getPrepayId.execute(entity);
	}
	...
	private class GetPrepayIdTask extends
		...
		protected Map<String, String> doInBackground(String... params) {
			...
			Log.e("orion_params", params[0]);
			byte[] buf = Util.httpPost(url, params[0]);
			String content = new String(buf);
			Log.e("orion_content", content);
	...
	private String genProductArgs(String name, String description,
		...
		try {
			...
			packageParams.add(new BasicNameValuePair("notify_url",
					SystemApplication.getInstance().getBaseurl()
					+ "TruckService/ReceiveWxNotify"));
			packageParams.add(new BasicNameValuePair("out_trade_no",
					ordernumber));
			Log.i("lxs", "数据库订单号===="+ordernumber);
